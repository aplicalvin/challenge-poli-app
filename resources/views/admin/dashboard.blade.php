...
<div class="space-y-10">
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      <div class="p-4 md:p-5 flex gap-x-4">
        <div class="shrink-0 flex justify-center items-center size-[46px] bg-blue-100 text-blue-600 rounded-lg dark:bg-blue-900/10 dark:text-blue-500">
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      <div class="p-4 md:p-5 flex gap-x-4">
        <div class="shrink-0 flex justify-center items-center size-[46px] bg-teal-100 text-teal-600 rounded-lg dark:bg-teal-900/10 dark:text-teal-500">
          <svg class="shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"/><path d="m8.5 8.5 7 7"/></svg>
        </div>
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      <div class="p-4 md:p-5 flex gap-x-4">
        <div class="shrink-0 flex justify-center items-center size-[46px] bg-orange-100 text-orange-600 rounded-lg dark:bg-orange-900/10 dark:text-orange-500">
          <svg class="shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
        </div>
  ...
  <div class="space-y-4">
    ...
    <div class="grid sm:grid-cols-3 gap-6">
      <!-- Add Doctor Shortcut -->
      <button type="button" 
              onclick="CrudHandler.openModal('hs-dashboard-add-dokter-modal')"
        ...
        <div class="p-4 md:p-5">
          <div class="flex items-center gap-x-2">
            <div class="shrink-0 flex justify-center items-center size-[38px] border border-gray-200 text-gray-500 rounded-lg group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 transition dark:border-neutral-700 dark:text-neutral-400 dark:group-hover:bg-blue-500">
              <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            </div>
            <div class="grow">
              <p class="text-sm font-semibold text-gray-800 group-hover:text-blue-600 transition dark:text-neutral-200 dark:group-hover:text-white">
                Add Doctor
              </p>
            </div>
          </div>
      ...
      <!-- Add Shift Shortcut -->
      <button type="button" 
              onclick="CrudHandler.openModal('hs-dashboard-add-shift-modal')"
              class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md focus:outline-hidden transition dark:bg-neutral-800 dark:border-neutral-700">
        <div class="p-4 md:p-5">
          <div class="flex items-center gap-x-2">
            <div class="shrink-0 flex justify-center items-center size-[38px] border border-gray-200 text-gray-500 rounded-lg group-hover:bg-teal-600 group-hover:text-white group-hover:border-teal-600 transition dark:border-neutral-700 dark:text-neutral-400 dark:group-hover:bg-teal-500">
              <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            </div>
            <div class="grow">
              <p class="text-sm font-semibold text-gray-800 group-hover:text-teal-600 transition dark:text-neutral-200 dark:group-hover:text-white">
                Add Shift
              </p>
            </div>
          </div>
      ...
      <button type="button" 
              onclick="CrudHandler.openModal('hs-dashboard-add-obat-modal')"
              class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md focus:outline-hidden transition dark:bg-neutral-800 dark:border-neutral-700">
        <div class="p-4 md:p-5">
          <div class="flex items-center gap-x-2">
            <div class="shrink-0 flex justify-center items-center size-[38px] border border-gray-200 text-gray-500 rounded-lg group-hover:bg-orange-600 group-hover:text-white group-hover:border-orange-600 transition dark:border-neutral-700 dark:text-neutral-400 dark:group-hover:bg-orange-500">
              <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
            </div>
            <div class="grow">
              <p class="text-sm font-semibold text-gray-800 group-hover:text-orange-600 transition dark:text-neutral-200 dark:group-hover:text-white">
                Add Medicine
              </p>
            </div>
          </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
          <thead class="bg-gray-50 dark:bg-neutral-800">
            <tr>
              ...
              <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Nama Poli</th>
              <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Keterangan</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-neutral-400">{{ $poli->keterangan ?? 'Aktif' }}</td>
            </tr>
            @empty
            <tr>
              <td colspan="3" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-neutral-400">Belum ada data poli.</td>
            </tr>
            @endforelse
          </tbody>
        </table>
  ...
  <form id="dashboard-add-dokter-form" action="{{ route('dokter.store') }}" method="POST">
    ...
    <div class="space-y-4">
      <div>
        ...
        <input type="text" name="nama" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
      </div>
      <div>
  ...
  <form id="dashboard-add-obat-form" action="{{ route('obat.list.store') }}" method="POST">
    ...
    <div class="space-y-4">
      <div>
        ...
        <input type="text" name="nama_obat" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
      </div>
      <div>
        <label class="block text-sm font-medium mb-2 dark:text-white">Kemasan</label>
        <input type="text" name="kemasan" placeholder="e.g. Strip / Botol" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
      </div>
      <div>
        <label class="block text-sm font-medium mb-2 dark:text-white">Harga (Rp)</label>
        <input type="number" name="harga" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400" required>
      </div>
    </div>
  </form>
  @slot('footer')
