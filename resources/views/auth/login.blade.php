...
@section('content')
  <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
    <div class="p-4 sm:p-7">
        ...
        <form action="{{ route('login') }}" method="POST">
          ...
          <div class="grid gap-y-4">
            ...
            <div>
              ...
              <span class="text-xs text-gray-500 dark:text-neutral-400 mb-4">Lupa password? Hubungi admin</span>
            </div>
          </div>
      </div>
      ...
      <button type="submit"
        class="w-full mt-5 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Masuk</button>
      </form>
    </div>
    <!-- End Form -->
  </div>
