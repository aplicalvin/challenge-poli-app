@php
    ...
    $menu = [
        ...
        [
            ...
            'roles' => ['admin'],
            'children' => [
                ['label' => 'Manajemen Poli', 'route' => '#'],
                ['label' => 'Manajemen Dokter', 'route' => '#'],
                ['label' => 'Manajemen Staff', 'route' => '#'],
                ['label' => 'Manajemen Pasien', 'route' => '#'],
            ]
        ],
        [
            'label' => 'Penjadwalan',
            ...
            'roles' => ['admin', 'dokter'],
            'children' => [
                ['label' => 'Manajemen Shift', 'route' => '#', 'roles' => ['admin']],
                ['label' => 'Manajemen Jadwal', 'route' => '#', 'roles' => ['admin', 'dokter', 'pasien']],
            ]
        ],
        [
            'label' => 'Obat',
            ...
            'children' => [
                ['label' => 'Manajemen Obat', 'route' => '#'],
                ['label' => 'Manajemen Stok Obat', 'route' => '#'],
            ]
        ],
        [
            'label' => 'Keuangan',
            ...
            'roles' => ['admin', 'kasir'],
            'children' => [
                ['label' => 'Manajemen Transaksi', 'route' => '#'],
                ['label' => 'Laporan Keuangan', 'route' => '#'],
            ]
        ],
        [
            'label' => 'Riwayat',
            ...
            'roles' => ['dokter', 'pasien'],
            'children' => [
                ['label' => 'Riwayat Periksa', 'route' => '#', 'roles' => ['dokter', 'pasien']],
                ['label' => 'Riwayat Pembayaran', 'route' => '#', 'roles' => ['pasien']],
            ]
        ],
        [
            'label' => 'Akun',
...
<div id="application-sidebar" class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 dark:bg-neutral-800 dark:border-neutral-700">
  <div class="px-6">
    <a class="flex-none text-xl font-semibold dark:text-white" href="/" aria-label="Brand">Poli App</a>
  </div>
  ...
  <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
    <ul class="space-y-1.5">
      @foreach($menu as $item)
        ...
        @if(!$hasChildren)
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ $isActive ? 'bg-gray-100 dark:bg-neutral-700 text-blue-600 dark:text-white' : 'text-gray-700 hover:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300' }} text-sm rounded-lg" href="{{ $href }}">
        ...
        @else
          <li class="hs-accordion" id="{{ $id }}">
            ...
            <div id="{{ $id }}-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
              <ul class="pt-2 ps-2">
                @foreach($item['children'] as $child)
                  ...
                  @endphp
                  <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300" href="{{ $childHref }}">
                      {{ $child['label'] }}
                    </a>
                  </li>
                @endforeach
