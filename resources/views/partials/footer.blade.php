  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
    <div class="text-center md:text-left">
      ...
      <p class="mt-3 text-sm text-gray-500 dark:text-neutral-500">
        Solusi manajemen kesehatan digital terintegrasi untuk masa depan.
      </p>
    </div>
    ...
    <div class="text-center md:text-right">
      ...
      <div class="mt-2 space-x-3">
        <a href="#" class="text-xs text-gray-400 hover:text-blue-600 transition-colors">Twitter</a>
        <a href="#" class="text-xs text-gray-400 hover:text-blue-600 transition-colors">LinkedIn</a>
        <a href="#" class="text-xs text-gray-400 hover:text-blue-600 transition-colors">GitHub</a>
      </div>
    </div>
  </div>
</footer>
